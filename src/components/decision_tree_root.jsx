...
class DecisionBranch extends React.Component {
  constructor(props) {
    super(props);
    this.divClassName = this.props.gui ? "col" : "col-md-10 col-md-offset-1";
...
// TODO: evaluate if the props (gui and changeAppState) exist before passing them down.
function DecisionTreeRoot(props) {
  var choices = [
    ...
    },
    {
      ...
      name: "recombination",
      child: <GARD gui={props.gui} changeAppState={props.changeAppState} />
    }
  ];
  return (
    <div>
  ...
  var choices = [
    {
      ...
      name: "branches",
      child: (
        <BranchesBranch gui={props.gui} changeAppState={props.changeAppState} />
      )
    },
    {
      displayName: "Sites",
      name: "sites",
      child: (
        <SitesBranch gui={props.gui} changeAppState={props.changeAppState} />
      )
    },
    {
      displayName: "Gene",
      name: "gene",
      child: <BUSTED gui={props.gui} changeAppState={props.changeAppState} />
    }
  ];
  return (
    <DecisionBranch
  ...
  var choices = [
    {
      ...
      name: "branches",
      child: <ABSREL gui={props.gui} changeAppState={props.changeAppState} />
    },
    {
      displayName: "Relaxed",
      name: "sites",
      child: <RELAX gui={props.gui} changeAppState={props.changeAppState} />
    }
  ];
  return (
    <DecisionBranch
  ...
  var choices = [
    {
      displayName: "Episodic",
      name: "episodic",
      child: <MEME gui={props.gui} changeAppState={props.changeAppState} />
    },
    {
  ...
  var choices = [
    {
      displayName: "Small",
      name: "small",
      child: <FEL gui={props.gui} changeAppState={props.changeAppState} />
    },
    {
      displayName: "Large",
      name: "large",
      child: (
        <LargeBranch gui={props.gui} changeAppState={props.changeAppState} />
      )
    }
  ];
  return (
  ...
  var choices = [
    {
      ...
      name: "bayesian",
      child: <FUBAR gui={props.gui} changeAppState={props.changeAppState} />
    },
    {
      displayName: "Counting",
      name: "counting",
      child: <SLAC gui={props.gui} changeAppState={props.changeAppState} />
    }
  ];
  return (
    <DecisionBranch
    ...
    return (
      <div className="row">
        <div className={this.divClassName}>
          ...
          >
            <h2 style={h2Style}>
              {this.props.gui ? "HyPhy " : "Datamonkey "}recommends that you
              use...
            </h2>
            <a
              href={this.props.gui ? null : this.props.href}
              onClick={
                this.props.gui ? () => this.goToMethod(this.props.href) : null
              }
...
function ABSREL(props) {
  return (
    ...
    >
      <p>
        aBSREL (<strong>a</strong>daptive
        <strong>B</strong>ranch-<strong>S</strong>ite <strong>R</strong>andom
        <strong>E</strong>ffects <strong>L</strong>ikelihood) is an improved
        version of the commonly-used "branch-site" models, which are used to
        test if positive selection has occurred on a proportion of branches.
      </p>
...
function BUSTED(props) {
  return (
    ...
    >
      <p>
        BUSTED (<strong>B</strong>ranch-site <strong>U</strong>nrestricted{" "}
        <strong>S</strong>tatistical <strong>T</strong>est for{" "}
        <strong>E</strong>pisodic <strong>D</strong>iversification) provides a
        gene-wide (<em>not site-specific</em>) test for positive selection by
        asking whether a gene has experienced positive selection at at least one
...
function MEME(props) {
  return (
    ...
    >
      <p>
        MEME (<strong>M</strong>ixed <strong>E</strong>ffects
        ...
        selection. In other words, MEME aims to detect sites evolving under
        positive selection under a proportion of branches.
      </p>
  ...
  return (
    ...
    >
      <p>
        ...
        infer nonsynoymous (dN) and synonymous (dS) substitution rates on a
        per-site basis for a given coding alignment and corresponding phylogeny.
        This method assumes that the selection pressure for each site is
        constant along the entire phylogeny.
      </p>
      <p>
        For more information, please see the{" "}
        <a
  ...
  return (
    ...
    >
      <p>
        ...
        corresponding phylogeny. This method assumes that the selection pressure
        for each site is constant along the entire phylogeny.
      </p>
...
function SLAC(props) {
  return (
    ...
    >
      <p>
        SLAC (<strong>S</strong>ingle-<strong>L</strong>ikelihood{" "}
        <strong>A</strong>ncestor <strong>C</strong>ounting) uses a combination
...
function render_decision_tree() {
  ReactDOM.render(<DecisionTreeRoot />, document.getElementById("main"));
}

module.exports.DecisionTreeRoot = DecisionTreeRoot;
module.exports.render_decision_tree = render_decision_tree;
