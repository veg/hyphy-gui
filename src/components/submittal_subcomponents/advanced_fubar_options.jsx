...
class AdvancedFubarOptions extends Component {
  ...
  onGridPointsChange = event => {
    ...
    if (value <= 0) {
      this.setState({
        message: "Please enter a positive number for the number of grid points"
      });
    } else {
  ...
  onMCMCChainsChange = event => {
    ...
    if (value <= 0) {
      this.setState({
        message: "Please enter a positive number for the number of MCMC chains"
      });
    } else {
      this.setState({ message: null });
    }
  ...
  onConcDirichletPriorChange = event => {
    ...
    if (value <= 0) {
      this.setState({
        message:
          "Please enter a positive number for the concentration parameter of the Dirichlet prior."
      });
    } else {
      this.setState({ message: null });
    }
            ...
            <div className="col-md-6">
              <div>
                ...
                <input
                  ...
                  type="number"
                  onChange={this.onGridPointsChange}
                  defaultValue="20"
                  step="1"
                  min="5"
                  max="50"
              ...
              <div>
                ...
                <input
                  ...
                  className="form-control"
                  type="number"
                  onChange={this.onMCMCChainsChange}
                  defaultValue="5"
                  step="1"
                  min="2"
                  max="20"
            ...
            <div className="col-md-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="form-control"
                  onChange={this.onConcDirichletPriorChange}
                  etype="number"
                  defaultValue=".5"
                  step="1"
                  min="0.001"
