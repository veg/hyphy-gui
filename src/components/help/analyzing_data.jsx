...
class AnalyzingData extends Component {
  constructor(props) {
    super(props);
  }
      ...
      <div>
        ...
        <div className="bs-callout bs-callout-info">
          ...
          <p>
            ...
            <a href="../paper.pdf">methods paper</a>). Characters without any
            information (all gaps or all missing) are NOT counted though, to
            avoid artifically high dN and dS estimates.
          </p>
        </div>
